...
6. **Перезагрузка страницы эвента жестом**
<br>Страница перезагружается при круговом движении мыши по часовой стрелке с зажатой правой кнопкой.

7. **Управление функционалом**
